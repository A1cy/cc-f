...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-ccevaluation-customer-details-id': RouteRecordInfo<'apps-ccevaluation-customer-details-id', '/apps/ccevaluation/customer/details/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-ccevaluation-customer-list': RouteRecordInfo<'apps-ccevaluation-customer-list', '/apps/ccevaluation/customer/list', Record<never, never>, Record<never, never>>,
    'apps-ccevaluation-manage-review': RouteRecordInfo<'apps-ccevaluation-manage-review', '/apps/ccevaluation/manage-review', Record<never, never>, Record<never, never>>,
    'apps-ccevaluation-order-details-id': RouteRecordInfo<'apps-ccevaluation-order-details-id', '/apps/ccevaluation/order/details/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-ccevaluation-order-list': RouteRecordInfo<'apps-ccevaluation-order-list', '/apps/ccevaluation/order/list', Record<never, never>, Record<never, never>>,
    'apps-ccevaluation-product-add': RouteRecordInfo<'apps-ccevaluation-product-add', '/apps/ccevaluation/product/add', Record<never, never>, Record<never, never>>,
    'apps-ccevaluation-product-category-list': RouteRecordInfo<'apps-ccevaluation-product-category-list', '/apps/ccevaluation/product/category-list', Record<never, never>, Record<never, never>>,
    'apps-ccevaluation-product-list': RouteRecordInfo<'apps-ccevaluation-product-list', '/apps/ccevaluation/product/list', Record<never, never>, Record<never, never>>,
    'apps-ccevaluation-referrals': RouteRecordInfo<'apps-ccevaluation-referrals', '/apps/ccevaluation/referrals', Record<never, never>, Record<never, never>>,
    'apps-ccevaluation-settings': RouteRecordInfo<'apps-ccevaluation-settings', '/apps/ccevaluation/settings', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-ccevaluation': RouteRecordInfo<'dashboards-ccevaluation', '/dashboards/ccevaluation', Record<never, never>, Record<never, never>>,
    ...
    'pages-user-profile-tab-x': RouteRecordInfo<'pages-user-profile-tab-x', '/pages/user-profile/:tab()X', { tab: ParamValue<true> }, { tab: ParamValue<false> }>,
    ...
    'tables-simple-table copy': RouteRecordInfo<'tables-simple-table copy', '/tables/simple-table copy', Record<never, never>, Record<never, never>>,
