  ...
  searchItems: [
    {
      ...
      children: [
        ...
        {
          url: { name: 'dashboards-ccevaluation' },
          icon: 'tabler-shopping-cart',
          title: 'ccevaluation Dashboard',
        },
        {
    ...
    },
    {
      ...
      children: [
        ...
        {
          url: { name: 'apps-ccevaluation-dashboard' },
          icon: 'tabler-shopping-cart',
          title: 'ccevaluation Dashboard',
        },
        {
          url: { name: 'apps-ccevaluation-product-list' },
          icon: 'tabler-list',
          title: 'ccevaluation - Product List',
        },
        {
          url: { name: 'apps-ccevaluation-product-add' },
          icon: 'tabler-circle-plus',
          title: 'ccevaluation - Add Product',
        },
        {
          url: { name: 'apps-ccevaluation-product-category-list' },
          icon: 'tabler-list',
          title: 'ccevaluation - Category List',
        },
        {
          url: { name: 'apps-ccevaluation-order-list' },
          icon: 'tabler-list',
          title: 'ccevaluation - Order List',
        },
        {
          url: { name: 'apps-ccevaluation-order-details-id', params: { id: '9042' } },
          icon: 'tabler-list-check',
          title: 'ccevaluation - Order Details',
        },
        {
          url: { name: 'apps-ccevaluation-customer-list' },
          icon: 'tabler-user',
          title: 'ccevaluation - Customer List',
        },
        {
          url: { name: 'apps-ccevaluation-customer-details-id', params: { id: '478426', tab: 'security' } },
          icon: 'tabler-list',
          title: 'ccevaluation - Customer Details',
        },
        {
          url: { name: 'apps-ccevaluation-manage-review' },
          icon: 'tabler-quote',
          title: 'ccevaluation - Manage Review',
        },
        {
          url: { name: 'apps-ccevaluation-referrals' },
          icon: 'tabler-users-group',
          title: 'ccevaluation - Referrals',
        },
        {
          url: { name: 'apps-ccevaluation-settings' },
          icon: 'tabler-settings',
          title: 'ccevaluation - Settings',
        },
        {
